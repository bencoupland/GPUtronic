// =============================================================================
// GPUTronic Q-Axis Governor v26.4 — Adaptive Hybrid (Floating Capacity)
// =============================================================================
// - Warm-up discovers initial max rate (soft starter only)
// - After warm-up: current_capacity slowly adapts upward
// - expected_rate = current_capacity * sleep_factor
// - Prevents anchoring to unrealistic warm-up max
// =============================================================================
...
void* control_loop(void* arg) {
    ...
    printf("[CTRL] v26.4 ADAPTIVE HYBRID | floating capacity model\n");
    ...
    while (g_running) {
        ...
        if (now < warmup_until) {
            ...
            calibration_done = 1;
            // Slowly adapt capacity upward only (floating reference)
...
int main(int argc, char** argv) {
    ...
    printf("═══════════════════════════════════════════════════════════\n");
    printf("[GPUTronic v26.4 ADAPTIVE] Floating capacity hybrid\n");
    printf("═══════════════════════════════════════════════════════════\n\n");
    ...
    printf("\n[GPUTronic v26.4 ADAPTIVE] Run complete. CSV: gputronic_log.csv\n");
