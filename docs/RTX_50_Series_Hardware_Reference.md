...
|-------|-----|-----|------------|-------------|------------|------------------|
| RTX 5090 | GB202 | ~170-192 | 1536 | ~261,120+ | ~21,760+ | GDDR7 (192-bit) |
| RTX 5080 | GB203 | 84 | 1536 | 128,960 | 10,752 | GDDR7 (192-bit) |
| RTX 5070 Ti | GB203 | 70 | 1536 | 107,520 | 8,960 | GDDR7 (192-bit) |
...
- **Memory interface**: Varies between models (GDDR7, 192-bit vs 128-bit)
